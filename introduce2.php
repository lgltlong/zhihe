...
<div id="intro-body" class="container mt-4">
	<div class="intro-item">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-1.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-2.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-4.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
	</div>
	...
	<div class="intro-item">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-5.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-6.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-7.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-8.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
		<img class="d-block w-100" src="<?php echo get_template_directory_uri().'/images/about-3.jpg';?>" alt="李嘉诚 致呵" title="李嘉诚 致呵">
	</div>
</div>
