...
<div id="index-pros" class="container-fluid mt-4">
	...
	<div class="sect-footer p-3">
		...
		<div class="d-flex justify-content-between">
			<a class="btn btn-primary" href="">营养包</a>
			<a class="btn btn-outline-primary" href="">免疫营养粉</a>
			<a class="btn btn-outline-primary" href="">营养蛋白质粉</a>
		</div>
		<div class="d-flex justify-content-between">
			<a class="btn btn-outline-primary" href="">微晶粉型固体饮料</a>
			<a class="btn btn-outline-primary" href="">软胶囊/凝胶糖果</a>
		</div>
	</div>
</div>
