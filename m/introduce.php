...
?>
	...
	<!-- intro body -->
	<div class="intro" class="container border border-primary">
		<div class="intro-head p-4">
			<h2 class="text-success text-center">
				广药白云山和记黄埔莱达
				<span class="text-danger">致呵</span>
			</h2>
		</div>

		<div class="intro-body p-4">
			<div class="img-item d-flex justify-content-center">
				<img src="<?php echo get_template_directory_uri().'/images/factory.jpg';?>">
			</div>
			...
			<div class="img-item d-flex justify-content-center">
				<img src="<?php echo get_template_directory_uri().'/images/ljc-1.jpg';?>">
			</div>
			...
			<div class="img-item d-flex justify-content-center">
				<img src="<?php echo get_template_directory_uri().'/images/ljc-3.jpg';?>">
			</div>
			...
			<div class="img-group d-flex justify-content-between">
				<img src="<?php echo get_template_directory_uri().'/images/ljc-1.jpg';?>">
				<img src="<?php echo get_template_directory_uri().'/images/ljc-3.jpg';?>">
				<img src="<?php echo get_template_directory_uri().'/images/ljc-4.jpg';?>">
			</div>
		</div>
	</div>
