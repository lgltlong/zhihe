...
get_header(); ?>
	...
	<div id="single" class="container mt-4">
		<div class="row">
			...
			<?php if( in_category( array('products','fhmyyyf','wjfxgtyl','yyb','yydbzf','pills'), get_the_ID() ) ):?>
					...
					<div class="single-content d-flex justify-content-between">
						...
						<div class="single-info w-50 p-3">
							<ul class="list-group">
								...
								<li class="list-group-item">
									<p>
										<span class="font-b">产品价格:</span>
										<?php echo get_post_meta(get_the_ID(),'pro_price', true);?>
									</p>
								</li>
							</ul>
						</div>
